...
<ul>
  ...
  <li> <b>Docker: </b>For the containerization of the application using a <b><a href = >Dockerfile</a></b> and <b>DockerHub account</b> for the management of repository and its tags.</li>
  <li> <b>Kubernetes: </b>For the orchestration of the Docker Container using a Kubernetes Cluster.</li>
  <li> <b>GitHub Actions: </b>For the automation of the workflow's execution using the file <a href = </a> that contains all steps of the creation of a CI/CD pipeline, from building to deployment.</li>
</ul>
